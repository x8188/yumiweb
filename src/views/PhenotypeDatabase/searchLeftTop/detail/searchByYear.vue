<template>
  <div class="content">
    <el-table :data="tableData" border style="width: 100%">
      ...
      <el-table-column prop="pedigree" label="系谱" width="280" :align="'center'"> </el-table-column>
      ...
      <el-table-column prop="leafwidth" label="穗上叶宽" :align="'center'"> </el-table-column>
      ...
      <el-table-column prop="stemrot" label="茎腐病(%)" width="120" :align="'center'"> </el-table-column>
