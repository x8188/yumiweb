  ...
  export default {
    ...
    methods: {
      ...
      handleExport(){
        ...
        const list = this.queryList
        this.$confirm("是否确认导出所有数据项?", "警告", {
        confirmButtonText: "确定",
        cancelButtonText: "取消",
        type: "warning",
      }).then(function(){
        return Download(this.queryList)
      }).then(res=>{
        this.download(res.msg)
      })
        // console.log(this.queryList)
        // this.download("variations/variant/download",this.queryList, `Importfeature_${new Date().getTime()}.xlsx`)
      },
      // 导出数据
