  ...
  <div class="filter_page">
    <el-row :gutter="12" class="filter_box">
      <el-form ref="elForm" :model="formData" :rules="rules" size="medium" >
        <el-col id="col-one">
          <span @click="filter_page()">Filter</span>
          <span id="span-second">Reset</span>
        </el-col>
        <el-col :span="6">
          <el-form-item label="Reference" prop="field101">
            <el-select v-model="formData.field101" placeholder="请选择Reference" clearable
              :style="{width: '100%'}">
              <el-option v-for="(item, index) in field101Options" :key="index" :label="item"
        ...
        <el-col :span="6">
          <el-form-item label="Version" prop="field102">
            <el-select v-model="formData.field102" placeholder="请选择Version" clearable
              :style="{width: '100%'}">
              <el-option v-for="(item, index) in field102Options" :key="index" :label="item"
                :value="index" :disabled="item.disabled"></el-option>
            </el-select>
          </el-form-item>
        </el-col>
        <el-col :span="6">
          <el-form-item label="Population" prop="field109">
            <el-select v-model="formData.field109" placeholder="请选择Population" clearable
              :style="{width: '100%'}">
              <el-option v-for="(item, index) in field109Options" :key="index" :label="item"
                :value="index" :disabled="item.disabled"></el-option>
            </el-select>
          </el-form-item>
        </el-col>
        <el-col :span="6">
          <el-form-item label="Analysis" prop="field108">
            <el-select v-model="formData.field108" placeholder="请选择Analysis" clearable
              :style="{width: '100%'}">
              <el-option v-for="(item, index) in field108Options" :key="index" :label="item"
                :value="index" :disabled="item.disabled"></el-option>
            </el-select>
          </el-form-item>
        </el-col>
        <el-col :span="6">
          <el-form-item label="Variant Class" prop="field105">
            <el-select v-model="formData.field105" placeholder="请选择Variant Class" clearable
              :style="{width: '100%'}">
              <el-option v-for="(item, index) in field105Options" :key="index" :label="item"
                :value="index" :disabled="item.disabled"></el-option>
            </el-select>
          </el-form-item>
        </el-col>
        <el-col :span="6">
          <el-form-item label="Region" prop="field106">
            <el-select v-model="formData.field106" placeholder="请选择Region" clearable :style="{width: '100%'}">
              <el-option v-for="(item, index) in field106Options" :key="index" :label="item"
                :value="index" :disabled="item.disabled"></el-option>
            </el-select>
          </el-form-item>
        </el-col>
        <el-col :span="6">
            ...
            <div id="inner_item">
              <!-- <span style="color: #606266; font-weight: 700; font-size: 14px;font-family: Helvetica Neue, Helvetica, PingFang SC, Hiragino Sans GB, Microsoft YaHei, Arial, sans-serif;">Consequence</span>
              <el-select  placeholder="Consequance">
                <el-option v-for="(item,index) in ConsequenceOptions" :key="index" :label="item" :value="index" :disabled="disabled
                "></el-option>
              </el-select>
              <span style="color: #606266;font-weight: 700;  font-size: 14px;font-family: Helvetica Neue, Helvetica, PingFang SC, Hiragino Sans GB, Microsoft YaHei, Arial, sans-serif;">Impacts</span>
              <el-select placeholder="Impacts">
                <el-option v-for="(item,index) in ImpactsOptions" :key="index" :label="item" :value="index" :disabled="disabled
                "></el-option>
              </el-select> -->
            ...
            <el-select v-model="formData.field103" placeholder="请选择Consqquance" clearable :style="{width: '100%'}">
              <el-option v-for="(item, index) in field103Options" :key="index" :label="item"
          ...
          <el-form-item label="Impacts" prop="field104">
            <el-select v-model="formData.field104" placeholder="请选择Region" clearable :style="{width: '100%'}">
              <el-option v-for="(item, index) in field104Options" :key="index" :label="item"
                :value="index" ></el-option>
            </el-select>
          </el-form-item>
            </div>
        ...
        <el-col :span="6">
          <el-form-item label="MAF" prop="field107">
            <el-select v-model="formData.field107" placeholder="请选择MAF" clearable :style="{width: '100%'}">
              <el-option v-for="(item, index) in field107Options" :key="index" :label="item"
                :value="index " :disabled="item.disabled"></el-option>
            </el-select>
          </el-form-item>
        </el-col>
  ...
  watch: {
    formData:{
      handler(Old,New){
        console.log(Old)
        console.log(New)
        this.accession = this.field101Options[New.field101] 
   ...
   //页面加载前请求
    Request_beforeMounted(){
      ...
      getSelectReference().then(res=>{
        this.field101Options = res
        // this.accession = this.field101Options[this.formData.field101]
        
      }).catch(err=>{
        console.log("Reference出现： "+err)
      })
      getSelectPopulation().then(res=>{
        this.field109Options =  res
      }).catch(err=>{
